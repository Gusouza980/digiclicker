...
- [ ] **DG-S04-001** (Data, M) — Criar catálogo de Essence.
- [ ] **DG-S04-002** (Data, P) — Criar catálogo de raridades de egg.
- [ ] **DG-S04-003** (Data, M) — Criar modelo de item no catálogo.
- [ ] **DG-S04-004** (Gameplay, G) — Implementar inventário stackável.
- [ ] **DG-S04-005** (Gameplay, G) — Implementar inventário de eggs.
- [ ] **DG-S04-006** (Gameplay, M) — Implementar drop de Essence.
- [ ] **DG-S04-007** (Gameplay, M) — Implementar drop de eggs.
- [ ] **DG-S04-008** (UI, G) — Criar tela de inventário.
- [ ] **DG-S04-009** (UI, M) — Exibir eggs não escaneados.
- [ ] **DG-S04-010** (Data, GG) — Criar catálogo das linhas de Adventure 1.
- [ ] **DG-S04-011** (Data, GG) — Definir stats base iniciais por forma.
- [ ] **DG-S04-012** (Data, G) — Definir Attribute, Element e tipo principal por forma.
- [ ] **DG-S04-013** (Data, M) — Criar catálogo de personalities.
- [ ] **DG-S04-014** (Gameplay, M) — Aplicar personality no crescimento by level.
- [ ] **DG-S04-015** (UI, G) — Criar tela de detalhes do Digimon.
- [ ] **DG-S04-016** (QA, M) — Validar se todos os Digimons do catálogo carregam corretamente.
