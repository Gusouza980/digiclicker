...
- [ ] **DG-S05-001** (Data, G) — Definir tabela de scan por tipo/raridade.
- [ ] **DG-S05-002** (Data, M) — Definir custo de scan em bits.
- [ ] **DG-S05-003** (Gameplay, G) — Implementar ação de scan.
- [ ] **DG-S05-004** (UI, G) — Criar tela/modal de scanner.
- [ ] **DG-S05-005** (Data, G) — Definir custo de Essence por inserção.
- [ ] **DG-S05-006** (Gameplay, G) — Implementar tentativa de inserção.
- [ ] **DG-S05-007** (Gameplay, M) — Implementar chances por número de inserção.
- [ ] **DG-S05-008** (Gameplay, M) — Implementar falha preservando egg.
- [ ] **DG-S05-009** (Gameplay, M) — Implementar quebra destruindo egg.
- [ ] **DG-S05-010** (Gameplay, G) — Implementar hatching após 3 inserções.
- [ ] **DG-S05-011** (Gameplay, M) — Implementar bônus 4/5 e 5/5.
- [ ] **DG-S05-012** (Gameplay, M) — Sortear personality ao chocar.
- [ ] **DG-S05-013** (Gameplay, M) — Enviar Digimon chocado para time ou Ilha.
- [ ] **DG-S05-014** (UI, M) — Exibir risco da próxima inserção.
- [ ] **DG-S05-015** (UI, M) — Criar feedback de sucesso/falha/quebra/hatch.
- [ ] **DG-S05-016** (Gameplay, M) — Implementar item inicial de proteção de egg, se entrar no MVP.
- [ ] **DG-S05-017** (QA, M) — Playtestar sensação de risco/recompensa.
